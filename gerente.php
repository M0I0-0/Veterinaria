...
<body>
    ...
    <div class="container">
        <section id="inventarios">
            <h2 class="section-title">Gestión de Inventarios</h2>
            <div class="card">
                <h3>Modificar Información de Productos</h3>
                <p>Puede gestionar entradas y salidas de mercancías y consultar el estado del inventario.</p>
                <a href="http://localhost/inventario/invenmov.php" class="btn">Modificar Productos</a>
            </div>
        </section>
        <section id="control">
            ...
            <div class="card">
                ...
                <a href="http://localhost/inventario/provemov.php" class="btn">Controlar Entregas</a>
            </div>
        </section>
        <section id="registros">
            <h2 class="section-title">Clientes</h2>
            <div class="card">
                <h3>Consultar y Modificar Registros</h3>
                <p>Desde aquí puedes gestionar los Clientes del sistema.</p>
                <a href="http://localhost/inventario/clientmov.php" class="btn">Ver Registros</a>
            </div>
        </section>
    </div>
